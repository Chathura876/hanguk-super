...
Route::middleware(['auth:owner'])->group(function () {
        ...
        Route::post('/create', [OwnerController::class, 'create'])->name('owner.create');
            ...
            Route::prefix('product_types')->group(function () {
                ...
                Route::post('/product-type/create/', [ProductTypeController::class, 'store_type'])->name('product.type_create');
                ...
                Route::post('product_type/update/{id}', [ProductTypeController::class, 'update'])->name('product-type.update');
            });
            ...
            Route::prefix('damage_items')->group(function () {
                ...
                Route::get('/{id}', [DamageItemsController::class, 'edit'])->name('damage_items.edit');
                Route::post('/{id}', [DamageItemsController::class, 'update'])->name('damage_items.update');
                Route::get('/delete/{id}', [DamageItemsController::class, 'destroy'])->name('damage_items.delete');
