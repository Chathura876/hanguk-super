                ...
                <div class="p-5">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <h4 class="text-2xl font-semibold text-default-900 mt-4">Rs {{ number_format($todayExpenses, 2) }}</h4>
                        </div>
                ...
                <div class="p-5">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <h4 class="text-2xl font-semibold text-default-900 mt-4">{{ number_format($previousWeekExpenses / 1000, 1) }}K</h4>
                        </div>
                ...
                <div class="p-5">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <h4 class="text-2xl font-semibold text-default-900 mt-4">{{ number_format($currentMonthExpenses / 1000, 1) }}K</h4>
                        </div>
                ...
                <div class="p-5">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <h4 class="text-2xl font-semibold text-default-900 mt-4">{{ number_format($julyExpenses / 1000, 1) }}K</h4>
                        </div>
                       ...
                       class="relative overflow-hidden py-2.5 pe-6 ps-12 inline-flex items-center justify-center font-semibold align-middle duration-500 text-sm text-center bg-primary-600 text-white rounded-full hover:bg-primary-700">
                        <span
                            class="absolute top-1/2 -translate-y-1/2 start-0 h-full w-10 rounded-full inline-flex items-center justify-center bg-white/20 text-white me-3"><i
                                class="ti ti-report text-xl"></i></span>
                        Report
                    </a>
                        ...
                        <tr>
                            ...
                            <td class="whitespace-nowrap py-3 px-3 text-center text-sm font-medium">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="{{ route('owner.edit_expenses', $expense->id) }}" type="button"
