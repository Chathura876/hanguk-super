        ...
        <div class="border border-default-200 rounded-lg">
            ...
            <div class="p-5 border-t border-dashed border-default-200">
                <div class="grid lg:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-default-900 mb-2" for="description">Expense Details</label>
                        <input id="description" name="description" class="block w-full rounded-md py-2.5 px-4 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50" type="text" placeholder="Add Description">
                    </div>
