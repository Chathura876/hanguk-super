...
@section('content')
    ...
    <div class="p-6 space-y-6">
        ...
        <div class="flex w-full items-center justify-between print:hidden">
            <h4 class="text-lg font-semibold text-default-900">Expenses Report</h4>
        ...
        <div class="border border-default-200 rounded-lg bg-white dark:bg-default-50 h-fit">
            ...
            {{--                <div class="">--}}
            {{--                    <h5 class="text-lg font-medium text-default-950 capitalize mb-1">Damage Items Report</h5>--}}
...
{{--                                                    </div> <!-- grid-end -->--}}
                                            ...
                                            <div>
                                                <div class="min-w-full inline-block align-middle overflow-hidden border border-default-200 rounded-md">
                                                    ...
                                                    <table class="min-w-full">
                                                        ...
                                                        <tr>
                                                            <th scope="col" class="px-6 py-2 text-left font-semibold text-default-500">Date</th>
                                                            <th scope="col" class="px-6 py-2 text-left font-semibold text-default-500">Expenses Details</th>
                                                            <th scope="col" class="px-6 py-2 text-left font-semibold text-default-500">Expenses Type</th>
                                                            <th scope="col" class="px-6 py-2 text-left font-semibold text-default-500">Add By</th>
                                                            <th scope="col" class="px-6 py-2 text-left font-semibold text-default-500">Amount</th>
                                                        </tr> <!-- tr-end -->
                                                        </thead> <!-- thead-end -->
                                                ...
                                                <div class="min-w-full inline-block align-middle overflow-hidden border border-default-200 rounded-md">
                                                    ...
                                                    <table class="min-w-full">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th scope="col" class="px-6 py-2 text-left font-semibold text-default-500">Free Items</th>
    ...
    <script>
        document.getElementById('all-select-categories').addEventListener('change', function() {
            ...
            var dropdown = document.querySelector('.hs-select');
            dropdown.classList.remove('open'); // Assuming 'open' class keeps the dropdown visible
        });
