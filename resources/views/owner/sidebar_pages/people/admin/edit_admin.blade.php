...
@section('content')
    ...
    <div class="p-6 space-y-6">
        ...
        <div class="flex w-full items-center justify-between print:hidden">
            <h4 class="text-lg font-semibold text-default-900">Edit Admin</h4>
                ...
                <div class="p-5 border-t border-dashed border-default-200">
                    <div class="grid lg:grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            ...
                            <input id="name" name="name" value="{{ old('name', $admin->name) }}" class="block w-full rounded-md py-2.5 px-4 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50" type="text" placeholder="Add Name">
                            @error('name')
                        ...
                        <div>
                            ...
                            <input id="phone" name="phone" value="{{ old('phone', $admin->phone) }}" class="block w-full rounded-md py-2.5 px-4 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50" type="text" placeholder="Add Phone">
                            @error('phone')
                            <p class="text-red-600 text-sm">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input id="email" name="email" value="{{ old('email', $admin->email) }}" class="block w-full rounded-md py-2.5 px-4 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50" type="email" placeholder="Add Email">
                            @error('email')
                            <p class="text-red-600 text-sm">{{ $message }}</p>
                            @enderror
                        </div>
