...
@section('content')
    ...
    <div class="p-6 space-y-6">
        ...
        <div class="flex w-full items-center justify-between print:hidden">
            <h4 class="text-lg font-semibold text-default-900">Return Item List</h4>
            ...
            <div class="border-t border-dashed border-default-200 relative overflow-x-auto">
                <table class="min-w-full">
                    ...
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3 text-start text-sm capitalize font-semibold text-default-900">Return Amount (Rs.)</th>
                        <th scope="col" class="px-6 py-3 text-start text-sm capitalize font-semibold text-default-900">Description</th>
...
{{--                        <th scope="col" class="px-6 py-3 text-start text-sm capitalize font-semibold text-default-900">Offer</th>--}}
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-base text-default-800"></td>
                        <td class="px-6 py-4 whitespace-nowrap text-base text-default-800"></td>
                        <td class="px-6 py-4 whitespace-nowrap text-base text-default-800"></td>
                        <td class="px-6 py-4 whitespace-nowrap text-base text-default-800"></td>
                        <td class="px-6 py-4 whitespace-nowrap text-base text-default-800"></td>
