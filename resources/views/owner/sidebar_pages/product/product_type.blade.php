                    ...
                    <form action="{{ route('product.type_create') }}" method="POST">
                        ...
                        <div class="grid lg:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <input id="product_type" name="type" class="block w-full rounded-md py-2.5 px-4 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50" type="text" placeholder="Add Product Type" value="{{ old('type') }}" required>
                            ...
                            <div>
                                ...
                                <input id="description" name="description" class="block w-full rounded-md py-2.5 px-4 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50" type="text" placeholder="Description" value="{{ old('description') }}">
