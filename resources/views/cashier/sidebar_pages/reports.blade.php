                    ...
                    <div class="border rounded-lg bg-white h-100">
                        <div class="p-4">
                            <div class="d-flex justify-content-between">
                                ...
                                <span class="d-inline-flex align-items-center justify-content-center rounded bg-primary bg-opacity-10 text-primary" style="width: 72px; height: 72px;">
                    ...
                    <div class="border rounded-lg bg-white h-100">
                        <div class="p-4">
                            <div class="d-flex justify-content-between">
                                ...
                                <span class="d-inline-flex align-items-center justify-content-center rounded bg-info bg-opacity-10 text-info" style="width: 72px; height: 72px;">
                    ...
                    <div class="border rounded-lg bg-white h-100">
                        <div class="p-4">
                            <div class="d-flex justify-content-between">
                                ...
                                <span class="d-inline-flex align-items-center justify-content-center rounded bg-warning bg-opacity-10 text-warning" style="width: 72px; height: 72px;">
                    ...
                    <div class="border rounded-lg bg-white h-100">
                        <div class="p-4">
                            <div class="d-flex justify-content-between">
                                ...
                                <span class="d-inline-flex align-items-center justify-content-center rounded bg-danger bg-opacity-10 text-danger" style="width: 72px; height: 72px;">
            ...
            <div class="p-5 border-t border-dashed border-default-200">
                <div class="border-bottom">
                    <nav class="nav" role="tablist">
                        <!-- Today Tab -->
                        <button type="button" class="nav-link active border rounded-top px-3 py-2 fw-semibold" id="card-type-tab-item-1" data-bs-toggle="tab" data-bs-target="#card-type-tab-1" aria-controls="card-type-tab-1" role="tab">
                            Today
                        </button>
                        <!-- Weekly Tab -->
                        <button type="button" class="nav-link border rounded-top px-3 py-2 fw-semibold" id="card-type-tab-item-2" data-bs-toggle="tab" data-bs-target="#card-type-tab-2" aria-controls="card-type-tab-2" role="tab">
                            Weekly
                        </button>
                        <!-- Monthly Tab -->
                        <button type="button" class="nav-link border rounded-top px-3 py-2 fw-semibold" id="card-type-tab-item-3" data-bs-toggle="tab" data-bs-target="#card-type-tab-3" aria-controls="card-type-tab-3" role="tab">
                            Monthly
                        </button>
                        <!-- Date Tab with Date Input -->
                        <button type="button" class="nav-link border rounded-top px-3 py-2 fw-semibold" id="card-type-tab-item-4" data-bs-toggle="tab" data-bs-target="#card-type-tab-4" aria-controls="card-type-tab-4" role="tab">
