...
@section('content')
    ...
    <div class="p-6 space-y-6">
        ...
        <div class="flex w-full items-center justify-between print:hidden">
            <h4 class="text-lg font-semibold text-default-900">Edit Damage Items</h4>
            ...
            <div class="p-5 border-t border-dashed border-default-200">
                <div class="grid lg:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <input id="qty" name="qty" class="block w-full rounded-md py-2.5 px-4 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50" type="text" placeholder="Edit Quantity">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-default-900 mb-2" for="date">Date</label>
                        <input id="date" name="date" class="block w-full rounded-md py-2.5 px-4 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50" type="date" placeholder="Edit Quantity">
                    </div>
