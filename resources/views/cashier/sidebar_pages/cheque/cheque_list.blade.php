            ...
            <div class="flex flex-wrap items-center justify-between py-4 px-5">
              ...
              <i class="ti ti-search text-lg/none"></i>
                ...
                <div class="flex flex-wrap items-center gap-2">
                    ...
                    <a href="{{ route("pos.add_cheque") }}" class="relative overflow-hidden py-2.5 pe-6 ps-12 inline-flex items-center justify-center font-semibold align-middle duration-500 text-sm text-center bg-primary-600 text-white rounded-full hover:bg-primary-700">
...
{{--                                <a href="{{ route("pos.view_cheque") }}" class="inline-flex items-center justify-center h-9 w-9 rounded-full bg-default-100 border border-default-200 text-default-900 transition-all duration-200 hover:border-primary hover:bg-primary hover:text-white">--}}
{{--                                    <i class="ti ti-eye text-base"></i>--}}
{{--                                </a>--}}
                                <a href="{{ route("pos.edit_cheque") }}" class="inline-flex items-center justify-center h-9 w-9 rounded-full bg-default-100 border border-default-200 text-default-900 transition-all duration-200 hover:border-primary hover:bg-primary hover:text-white">
