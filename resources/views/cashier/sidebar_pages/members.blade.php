            ...
            <div class="border-t border-dashed border-default-200 relative overflow-x-auto">
                <table class="min-w-full">
                    ...
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3 text-start text-sm capitalize font-semibold text-default-900">Phone Number</th>
...
{{--                        <th scope="col" class="px-6 py-3 text-center text-sm capitalize font-semibold text-default-900 min-w-32">Action</th>--}}
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-base text-default-800">Bandara</td>
                        <td class="px-6 py-4 whitespace-nowrap text-base text-default-800">807784177V</td>
                        <td class="px-6 py-4 whitespace-nowrap text-base text-default-800">namal@gmail.com</td>
                        <td class="px-6 py-4 whitespace-nowrap text-base text-default-800">02.01.1980 </td>
                        <td class="px-6 py-4 whitespace-nowrap text-base text-default-800">077414449</td>
{{--                        <td class="whitespace-nowrap py-3 px-3 text-center text-sm font-medium">--}}
{{--                            <div class="flex items-center justify-center gap-2">--}}
{{--                                --}}{{--                                <a href="{{ route("owner.view_cashier") }}" class="inline-flex items-center justify-center h-9 w-9 rounded-full bg-default-100 border border-default-200 text-default-900 transition-all duration-200 hover:border-primary hover:bg-primary hover:text-white">--}}
{{--                                --}}{{--                                    <i class="ti ti-eye text-lg"></i>--}}
{{--                                --}}{{--                                </a>--}}
{{--                                <a href="{{ route("owner.edit_customer") }}" type="button" class="inline-flex items-center justify-center h-9 w-9 rounded-full bg-default-100 border border-default-200 text-default-900 transition-all duration-200 hover:border-primary hover:bg-primary hover:text-white">--}}
